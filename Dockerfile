...
\
&& wget https://github.com/nghttp2/nghttp2/releases/download/v1.21.0/nghttp2-1.21.0.tar.gz && tar -zxvf nghttp2* && rm -f *.gz \
&& wget https://curl.haxx.se/download/curl-7.53.1.tar.gz && tar -zxvf curl* && rm -f *.gz \
